...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/infotechIT'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/infotechIT/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/infotechIT/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/infotechIT'),     
        ],
        [
